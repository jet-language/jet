...
_No cards open. The `Rollback` trait shape (**D-ROLLBACK-TRAIT**) was decided **A** and
ratified into [`syntax-decisions.md`](syntax-decisions.md), closing D-TXN-ROLLBACK layer 2.
The earlier batch is recorded there too._
