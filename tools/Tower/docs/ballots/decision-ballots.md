...
> surface is now fully decided (D-EFF1+D-QUAL1+D-EFF2+D-EFF3). **No full decision cards
> remain open.** What's left below is informational only: the **deferred-ballots list**
