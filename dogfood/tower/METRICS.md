...
The following checks passed in the captured canary before this lane's route-guard edit:
...
The captured canary's `scripts/agent/jet-env jet check dogfood/tower` exited 0 with 14 warnings:
