...
const CONTAINERS = {
  ...
  "core.net": ["net"],
  "core.net.tls": ["crypto/tls", "crypto/x509"],
  "core.http": ["net/http"],
  "core.net.url": ["net/url"],
...
const ABSENT = {
  ...
  "core.sys": "environment access lives in the os package, recorded under core.sys",
  "core.text.fmt": "formatting lives in the fmt package, recorded under core.term",
  ...
  Rank: "no Go standard-library ordered set",
  Cache: "no Go standard-library cache with an eviction policy",
  "core.crypto.uuid": "no Go standard-library UUID generator",
