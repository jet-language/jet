...
absent = [
  ...
  {"core.sys", "environment access lives in System, recorded under core.sys"},
  {"core.process", "process control lives in System and Port, recorded under core.sys"},
  ...
  {"Bits", "no Elixir standard-library bit set; bitstrings carry bit operations"},
  {"Cache", "no Elixir standard-library cache with an eviction policy"},
  {"core.crypto.uuid", "no Elixir standard-library UUID generator"},
