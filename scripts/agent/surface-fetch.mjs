...
const SWIFT_ABSENT = {
  ...
  "core.net.mime": "no Swift standard-library MIME database",
  ...
  Rank: "no Swift standard-library ordered set; swift-collections is a separate package",
  Queue: "no Swift standard-library double-ended queue; swift-collections is a separate package",
  PriorityQueue: "no Swift standard-library priority queue; swift-collections is a separate package",
  Bits: "no Swift standard-library bit set; integers carry bit operations",
  Cache: "no Swift standard-library cache with an eviction policy",
  Bytes: "no Swift standard-library byte buffer; Data belongs to Foundation",
  "core.math.random": "SystemRandomNumberGenerator seeds randomness, but Swift ships no random module",
  ...
  "core.sys": "ProcessInfo belongs to Foundation, not the Swift standard library",
  "core.sys": "ProcessInfo belongs to Foundation, not the Swift standard library",
  ...
  "core.net.tls": "TLS belongs to Network and Security, not the Swift standard library",
  "core.http": "URLSession belongs to Foundation, not the Swift standard library",
  "core.net.url": "URL belongs to Foundation, not the Swift standard library",
  "core.crypto.uuid": "UUID belongs to Foundation, not the Swift standard library",
  ...
  "core.encoding": "no Swift standard-library binary reader; Foundation Data carries it",
  "core.term": "print is a standard-library function, but Swift ships no console module",
  "core.text.fmt": "String interpolation is syntax; Swift ships no formatting module",
  "core.text": "Unicode scalar properties exist on Unicode.Scalar, but Swift ships no Unicode database module",
};
...
const KOTLIN_ABSENT = {
  ...
  "core.net.mime": "no Kotlin standard-library MIME database",
  ...
  Rank: "sortedSetOf returns a Java ordered-set type; the Kotlin standard library declares no ordered set of its own",
  Queue: "ArrayDeque is a Kotlin class but the standard library declares no double-ended queue package surface of its own",
  PriorityQueue: "no Kotlin standard-library priority queue; java.util.PriorityQueue is a JDK type",
  Bits: "no Kotlin standard-library bit set; integers carry bit operations",
  Cache: "no Kotlin standard-library cache with an eviction policy",
  Bytes: "ByteArray is a Kotlin type but the standard library declares no byte-buffer package surface",
  ...
  "core.sys": "no Kotlin standard-library environment module; System is a JDK type",
  "core.sys": "no Kotlin standard-library operating-system module",
  ...
  "core.net.tls": "no Kotlin standard-library TLS client",
  "core.http": "ktor is a separate library, not the Kotlin standard library",
  "core.net.url": "no Kotlin standard-library URL parser",
  ...
  "core.encoding": "no Kotlin standard-library binary reader",
  "core.text.fmt": "no Kotlin standard-library formatting module beyond kotlin.text",
  "core.text": "no Kotlin standard-library Unicode property database",
};
...
const CSHARP = {
  ...
  Rank: ["System.Collections.Generic/%53orted%53et`1"],
  ...
  "core.math.random": ["System/Random"],
  ...
  "core.sys": ["System/Environment"],
  "core.process": ["System.Diagnostics/Process"],
  "core.net": ["System.Net.Sockets/Socket"],
  "core.net.tls": ["System.Net.Security/SslStream"],
  "core.http": ["System.Net.Http/HttpClient"],
  "core.net.url": ["System/Uri"],
  "core.crypto.uuid": ["System/Guid"],
  ...
  "core.net.mime": ["System.Net.Mime/ContentType"],
  "core.encoding.xml": ["System.Xml/XmlDocument"],
  "core.mem": ["System/GC"],
  "core.archive": ["System.IO.Compression/ZipFile"],
  "core.encoding": ["System.IO/BinaryReader"],
  "core.term": ["System/Console"],
  "core.text": ["System.Globalization/CharUnicodeInfo"],
};
...
const CSHARP_ABSENT = {
  ...
  "core.term": "console control lives on System.Console, recorded under core.term",
  "core.web": "ASP.NET Core ships separately from the base class library",
  "core.sys": "environment access lives on System.Environment, recorded under core.sys",
  "core.text.fmt": "formatting lives on System.String, recorded under String",
...
const JULIA_ABSENT = {
  ...
  "core.reflect": "reflection is documented on the base manual page, recorded under core.sys",
  "core.net.mime": "no Julia standard-library MIME database beyond display types",
  ...
  "core.sys": "environment access is documented on the base manual page, recorded under core.sys",
  ...
  "core.net": "networking is documented on the io-network manual page, recorded under core.term",
  "core.encoding": "binary reading is documented on the io-network manual page, recorded under core.term",
  "core.process": "process control is documented on the base manual page, recorded under core.sys",
  ...
  Rank: "no Julia standard-library ordered set; DataStructures.jl is a package",
  Queue: "no Julia standard-library double-ended queue; DataStructures.jl is a package",
  PriorityQueue: "no Julia standard-library priority queue; DataStructures.jl is a package",
  Bits: "the bit-set type exists in Base, but the manual documents it inside collections rather than as its own surface",
  Cache: "no Julia standard-library cache with an eviction policy",
  Bytes: "IOBuffer exists in Base, but the manual documents it inside io-network rather than as its own surface",
  ...
  "core.net.tls": "no Julia standard-library TLS client; MbedTLS.jl is a package",
  "core.http": "no Julia standard-library HTTP client; HTTP.jl is a package",
  "core.net.url": "no Julia standard-library URL parser; URIs.jl is a package",
  "core.text.fmt": "Printf ships in the standard library, but the manual documents it outside the fetched pages",
  "core.text": "no Julia standard-library Unicode property database beyond Base.Unicode",
};
...
const R_ABSENT = {
  "core.math.random": R_OUT_OF_CLAIM,
  ...
  Rank: "no R base ordered set",
  Queue: "no R base double-ended queue",
  PriorityQueue: "no R base priority queue",
  Bits: "no R base bit set; logical vectors carry the workflow",
  Cache: "no R base cache with an eviction policy",
  Bytes: "raw vectors carry bytes, but R base ships no buffer type",
  List: R_OUT_OF_CLAIM,
  Map: R_OUT_OF_CLAIM,
  String: R_OUT_OF_CLAIM,
  "core.archive": R_OUT_OF_CLAIM,
  "core.encoding": R_OUT_OF_CLAIM,
  ...
  "core.sys": R_OUT_OF_CLAIM,
  "core.files": R_OUT_OF_CLAIM,
  "core.text.fmt": R_OUT_OF_CLAIM,
  ...
  "core.net.tls": R_OUT_OF_CLAIM,
  "core.net.url": R_OUT_OF_CLAIM,
  "core.crypto.uuid": R_OUT_OF_CLAIM,
  "core.args": R_OUT_OF_CLAIM,
  "core.email": R_OUT_OF_CLAIM,
  "core.sync": R_OUT_OF_CLAIM,
  "core.reflect": R_OUT_OF_CLAIM,
  "core.net.mime": R_OUT_OF_CLAIM,
