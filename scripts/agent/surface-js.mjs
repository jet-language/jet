...
const ABSENT = {
  ...
  "core.net.mime": "MIME types are a host concern, not ECMAScript",
  ...
  Rank: "no ECMAScript built-in ordered set",
  Queue: "no ECMAScript built-in double-ended queue",
  PriorityQueue: "no ECMAScript built-in priority queue",
  Bits: "no ECMAScript built-in bit set; integers carry bit operations",
  Cache: "no ECMAScript built-in cache with an eviction policy",
  "core.math.random": "Math.random seeds randomness, but ECMAScript ships no random module",
  ...
  "core.sys": "environment access is a Node host API, not ECMAScript",
  "core.sys": "operating-system access is a Node host API, not ECMAScript",
  "core.process": "process control is a Node host API, not ECMAScript",
  "core.net": "sockets are a Node host API, not ECMAScript",
  "core.net.tls": "TLS is a Node host API, not ECMAScript",
  "core.http": "fetch is a host API, not ECMAScript",
  "core.crypto.uuid": "randomUUID is a Web Crypto host API, not ECMAScript",
  "core.db": "no ECMAScript database client",
  "core.log": "console is a host API, not ECMAScript",
  "core.term": "console and stdio are host APIs, not ECMAScript",
  "core.text.fmt": "template literals are syntax; ECMAScript ships no formatting module",
  "core.archive": "compression streams are a host API, not ECMAScript",
  "core.encoding": "no ECMAScript binary reader beyond DataView, which is recorded under Bytes",
  "core.data": "no ECMAScript statistics",
  "core.testing": "no ECMAScript test harness",
  "core.text": "Intl exposes locale data, but ECMAScript ships no Unicode property database",
};
