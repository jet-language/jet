...
const CONTAINERS = {
  ...
  Rank: ["alloc/src/collections/btree/set.rs"],
  Queue: ["alloc/src/collections/vec_deque/mod.rs"],
...
const ABSENT = {
  ...
  "core.net.mime": "no Rust standard-library MIME database",
  ...
  "core.sys": "environment access lives in std::env, recorded under core.sys",
  "core.encoding": "binary reading lives in std::io, recorded under core.term",
  "core.text": "text handling lives on str and String, recorded under String",
  Bits: "no Rust standard-library bit set; integers carry bit operations",
  Cache: "no Rust standard-library cache with an eviction policy",
  "core.math.random": "no Rust standard-library random number generator",
  ...
  "core.net.url": "no Rust standard-library URL parser",
  "core.net.tls": "no Rust standard-library TLS client",
  "core.http": "no Rust standard-library HTTP client or server",
  "core.crypto.uuid": "no Rust standard-library UUID generator",
  ...
  "core.text": "no Rust standard-library Unicode property database",
};
