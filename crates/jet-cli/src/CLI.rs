    ...
    match shell {
        ...
        "zsh" => {
            ...
            Some(format!(
                ...
                zsh_single(program), jet_foundation::CliSchema::RECORD_VERSION, args,
            ))
        }
        "fish" => {
            let mut out = format!("# fish completion for {program} (JetCommandSchema v{})\n", jet_foundation::CliSchema::RECORD_VERSION);
