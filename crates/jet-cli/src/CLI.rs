...
const HANGAR_ACTIONS: &[NestedCommandSpec] = &[
    ...
    NestedCommandSpec { name: "recover", usage: "recover", summary: "Recover Hangar staging, build scratch, and leases", handler: HandlerKey::Hangar, also_canonical_top_level: false },
