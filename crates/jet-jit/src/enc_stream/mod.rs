...
pub(crate) mod runtime {
    ...
    pub mod jet_std {
        ...
        pub(crate) use crate::Encoding::json_rt::{
            EncodingCause, EncodingError, EncodingErrorKind, EncodingFormat, EncodingLimits,
        };
        ...
        pub enum DataEvent {
            ...
            // EncodingTypes.rs so the JIT host and AOT agree on the variant set.
            Number(String),
            Text(String),
            Bytes(Vec<u8>),
            ArrayStart,
        ...
        pub(crate) use jet_foundation::DataTree::DataTree;
        ...
        // The Foundation implementation is the canonical compiled routine;
...
fn result_err_encoding(error: &runtime::jet_std::EncodingError) -> i64 {
    Concurrency::with_runtime_mut(|rt| {
        let format = match error.format {
            ...
            runtime::jet_std::EncodingFormat::TOML => 3,
            runtime::jet_std::EncodingFormat::YAML => 4,
            runtime::jet_std::EncodingFormat::XML => 5,
            runtime::jet_std::EncodingFormat::CBOR => 6,
        };
...
host_fns! {
    ...
    json_writer_flush_enc: "jet_enc_json_writer_flush" => jet_jit_json_writer_flush: sig_unary;
    json_writer_finish: "jet_jit_json_writer_finish" => jet_jit_json_writer_finish: sig_unary;
    json_writer_finish_enc: "jet_enc_json_writer_finish" => jet_jit_json_writer_finish: sig_unary;
    json_reader_next: "jet_jit_json_reader_next" => jet_jit_json_reader_next: sig_unary;
    json_reader_next_enc: "jet_enc_json_reader_next" => jet_jit_json_reader_next: sig_unary;
    jsonl_writer_write: "jet_jit_jsonl_writer_write" => jet_jit_jsonl_writer_write: sig_binary;
    jsonl_writer_write_enc: "jet_enc_jsonl_writer_write" => jet_jit_jsonl_writer_write: sig_binary;
    jsonl_writer_flush: "jet_jit_jsonl_writer_flush" => jet_jit_jsonl_writer_flush: sig_unary;
    jsonl_writer_flush_enc: "jet_enc_jsonl_writer_flush" => jet_jit_jsonl_writer_flush: sig_unary;
    jsonl_writer_finish: "jet_jit_jsonl_writer_finish" => jet_jit_jsonl_writer_finish: sig_unary;
    jsonl_writer_finish_enc: "jet_enc_jsonl_writer_finish" => jet_jit_jsonl_writer_finish: sig_unary;
    jsonl_reader_next: "jet_jit_jsonl_reader_next" => jet_jit_jsonl_reader_next: sig_unary;
    jsonl_reader_next_enc: "jet_enc_jsonl_reader_next" => jet_jit_jsonl_reader_next: sig_unary;
    csv_writer_write: "jet_jit_csv_writer_write" => jet_jit_csv_writer_write: sig_binary;
    csv_writer_write_enc: "jet_enc_csv_writer_write" => jet_jit_csv_writer_write: sig_binary;
    csv_writer_flush: "jet_jit_csv_writer_flush" => jet_jit_csv_writer_flush: sig_unary;
    csv_writer_flush_enc: "jet_enc_csv_writer_flush" => jet_jit_csv_writer_flush: sig_unary;
    csv_writer_finish: "jet_jit_csv_writer_finish" => jet_jit_csv_writer_finish: sig_unary;
    csv_writer_finish_enc: "jet_enc_csv_writer_finish" => jet_jit_csv_writer_finish: sig_unary;
