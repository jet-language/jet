...
pub fn core_module_items(module: &str) -> Vec<String> {
    ...
    let items: &[&str] = match module {
        ...
        "core.sys" => &[
            ...
            "stop",
            "atexit",
            // POSIX process/session control — sema requires `#Unsafe` (#1465).
            "fork",
            "setuid",
            "setgid",
            "setpgid",
        ...
        "core.process" => &["exit", "run", "cmd", "pipeline", "argv", "args"],
        "core.math" => &[
            "sqrt",
            "pow",
            "abs",
            ...
            "checked_rem",
            "fraction",
            // D-CORESURFACE1 continued (#1464): float classify, decompose, and
            // the remaining high-witness math gaps.
            "is_normal",
            "is_subnormal",
            "is_canonical",
            "is_signed",
        ...
        "core.data.plot" => &["bar_text", "bar_svg", "line_text", "line_svg"],
        ...
        "core.tasks" => &["yield_now", "current_task", "after", "interval"],
        "core.testing" => &[
            "snap",
            "golden",
            "fixture",
        ...
        "core.email" => &[
            Syntax::TYPE_EMAIL_ADDRESS,
            Syntax::TYPE_EMAIL_MESSAGE,
            Syntax::TYPE_EMAIL_ATTACHMENT,
            Syntax::TYPE_EMAIL_ENVELOPE,
            Syntax::TYPE_EMAIL_SMTP_SECURITY,
            Syntax::TYPE_EMAIL_RECIPIENT_POLICY,
            Syntax::TYPE_EMAIL_RECIPIENT_REPORT,
            Syntax::TYPE_EMAIL_SEND_REPORT,
            Syntax::TYPE_EMAIL_ERROR,
            Syntax::TYPE_EMAIL_LIMITS,
            Syntax::TYPE_EMAIL_SMTP_AUTH,
            Syntax::TYPE_EMAIL_TLS_TRUST,
            Syntax::TYPE_EMAIL_SMTP_CONFIG,
            Syntax::TYPE_EMAIL_MAILER,
            Syntax::CORE_EMAIL_ADDRESS_FN,
            Syntax::CORE_EMAIL_ATTACHMENT_FN,
            Syntax::CORE_EMAIL_MESSAGE_FN,
            Syntax::CORE_EMAIL_ENVELOPE_FN,
            Syntax::CORE_EMAIL_SERIALIZE_FN,
            Syntax::CORE_EMAIL_SMTP_FN,
            Syntax::CORE_EMAIL_SMTP_FROM_ENV_FN,
        ],
