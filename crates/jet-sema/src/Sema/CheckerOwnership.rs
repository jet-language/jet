...
impl<'a> Checker<'a> {
    ...
    pub(crate) fn finish_cell_guard_map(
        ...
        let projected =
            self.finish_shared_closure("map", inner, args, span, editable, false)?;
        Some(Type::Apply {
    ...
    pub(crate) fn finish_cell_guard_split(
        ...
        let first =
            self.finish_shared_closure("split", inner, first_arg, span, editable, false)?;
        let second =
            self.finish_shared_closure("split", inner, second_arg, span, editable, false)?;
        Some(Type::Tuple(vec![
            (
                "first".to_string(),
                Box::new(Type::Apply {
