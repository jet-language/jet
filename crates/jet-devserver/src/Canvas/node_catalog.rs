...
pub(super) static NODE_DESCRIPTORS: &[NodeDescriptor] = &[
    ...
    NodeDescriptor {
        ...
        presentation: presentation(
            "Control",
            "↩",
            "Closes this resource when the scope exits.",
            "archetype",
            "archetype",
            "control",
            "exit",
        ...
        palette: palette(false, false, "Execution", 0, &["defer", "close", "cleanup"]),
        transaction: None,
        default_editor: "inline_expr",
    },
    NodeDescriptor {
    ...
    NodeDescriptor {
        ...
        presentation: presentation(
            "Statement state",
            "◉",
            "Controls whether this statement runs.",
            "archetype",
            "archetype",
            "control",
            "control",
        ...
        palette: palette(false, false, "Execution", 0, &[]),
        transaction: None,
        default_editor: "none",
    },
    NodeDescriptor {
