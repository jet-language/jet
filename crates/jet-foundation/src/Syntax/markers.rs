...
pub const APPLIED_RULES: &[&str] = &[
    ...
    ATTR_EVERY,
    ATTR_TRACK,
    // D-DATARACE1=C: `#Local` / `#Shared` reactive pins (Syntax::math_layout).
    ATTR_LOCAL,
    ATTR_SHARED,
    ATTR_OFF,
    ATTR_DEBUG_ONLY,
...
use super::{
    ...
    ATTR_FLATTEN, ATTR_HTML, ATTR_INVARIANT, ATTR_LAYOUT, ATTR_LIVE, ATTR_LOCAL, ATTR_META,
    ATTR_MUST_USE, ATTR_NONDETERMINISTIC, ATTR_NUMERIC, ATTR_OFF, ATTR_POLICY,
    ATTR_PUBLISHED_SCHEMA, ATTR_REDACT, ATTR_REGION, ATTR_RENAME, ATTR_RENAME_ALL, ATTR_REPLAYABLE,
    ATTR_SHARED, ATTR_SINGLE_USE, ATTR_SKIP, ATTR_SUMMARIZE, ATTR_TAG, ATTR_TARGET, ATTR_TRACK,
    ATTR_UNIT_FAMILY, ATTR_UNTAGGED, ATTR_WASM_EXPORT, CTX_BLOCK, DSL_BLOCK_SQL, KW_BENCH, KW_CAPS,
    KW_GRANT, KW_IMPURE, KW_PURE, KW_REACTIVE, KW_SANITIZER, KW_SHIELD, KW_STATE, KW_TAINTED, KW_TASK,
    KW_TEST, KW_TODO, KW_TRANSACT, KW_TRANSITION, KW_UNSAFE, MARKER_NO_PRELUDE, MARKER_PUB_FILE,
};
