...
/// D-EVENT-CONTINUE1=C: typed cancellable/transforming decision hooks.
pub const TYPE_DECISION_HOOK: &str = "DecisionHook";
pub const TYPE_HOOK_POLICY: &str = "HookPolicy";
pub const TYPE_HOOK_DECISION: &str = "HookDecision";
pub const TYPE_HOOK_OUTCOME: &str = "HookOutcome";
...
pub const FIRST_PARTY_RESERVED: &[&str] = &[
    "core", "jet", "c", "rust", "py", "js", "swift", "go", "java", "cs", "tcl", "lua", "fortran", "cobol", "ada", "pascal", "dart", "pwsh", "perl", "r", "com", "http", "regex", "csv", "toml", "crypto",
    "archive",
];
...
pub const LUA_MODULE_ROOT: &str = "lua"; // D-FFI-LUA1 / D-FFI-UNIFY1
