...
pub const CORE_CALLS: &[CoreCallRecord] = &[
    ...
    CoreCallRecord::new(
        "core.tasks",
        "current_task",
        "jet_std::jet_task_current_trace",
        true,
        &[],
    ),
    CoreCallRecord::new(
    ...
    CoreCallRecord::new(
        "core.time",
        "sleep",
        "jet_std_time_sleep_duration_ns",
        true,
        &[false],
    ),
    ...
    CoreCallRecord::new(
        ...
        "jet_services_delivery_at_most_once",
        true,
        &[],
    ),
    CoreCallRecord::new(
    ...
    CoreCallRecord::new(
        "core.encoding.cbor",
        "to_bytes_canonical",
        "jet_enc_cbor_to_bytes_canonical",
        true,
        &[true],
    ),
    CoreCallRecord::new(
    ...
    CoreCallRecord::new(
        "core.net.url",
        "percent_encode",
        "jet_url_percent_encode_component",
        true,
        &[true],
    ),
    CoreCallRecord::new(
        "core.net.url",
        "percent_decode",
        "jet_url_percent_decode_component",
        true,
        &[true],
    ),
    ...
    CoreCallRecord::new(
        ...
        "jet_net_listener_local_socket_addr",
        true,
        &[true],
    ),
    ...
    CoreCallRecord::new(
        "core.net",
        "udp_packet_original_len",
        "jet_net_udp_packet_original_len",
        true,
        &[true],
    )
    .with_pure_route(CoreCallPureRoute::Net),
    ...
    CoreCallRecord::new(
        "core.web.devserver",
        "for_app",
        "jet_devserver_for_app",
        true,
        &[true],
    ), // c-devserver (owner-directed 2026-07-01): `devserver.for_app(file)` // constructor — the builder methods dispatch through // `THandleOp::DevServerMethod` above, not here.
    ...
    CoreCallRecord::new(
        "core.http.server",
        "request_id",
        "jet_http_srv_install_request_id",
        false,
        &[true],
    ),
    ...
    CoreCallRecord::new(
        "core.crypto",
        "__signature_bytes",
        "jet_crypto_signature_bytes_impl",
        false,
        &[true],
    )
    .with_pure_route(CoreCallPureRoute::Crypto)
    ...
    CoreCallRecord::new(
        "core.crypto",
        "__verify_key_bytes",
        "jet_crypto_verify_key_bytes_impl",
        false,
        &[true],
    )
    .with_pure_route(CoreCallPureRoute::Crypto)
    ...
    CoreCallRecord::new(
        ...
        "jet_crypto_x25519_public_bytes_impl",
        false,
        &[true],
    )
    .with_pure_route(CoreCallPureRoute::Crypto)
    ...
    CoreCallRecord::new(
        "core.crypto",
        "__digest256_bytes",
        "jet_crypto_digest256_bytes_impl",
        false,
        &[true],
    )
    .with_pure_route(CoreCallPureRoute::Crypto)
    ...
    CoreCallRecord::new(
        "core.crypto",
        "__digest512_bytes",
        "jet_crypto_digest512_bytes_impl",
        false,
        &[true],
    )
    .with_pure_route(CoreCallPureRoute::Crypto)
