...
/// Byte values use the typed list head above; this pattern form remains
/// distinct because its body contains holes.
...
use super::{
    ...
    KW_IMPURE, KW_IN, KW_IT, KW_JOB, KW_LOOP, KW_MARKER, KW_MODULE, KW_POLICY, KW_PRIV,
    KW_PROTOCOL, KW_PUB, KW_RETURN, KW_SELF, KW_SHARED, KW_STATE, KW_STATE_DECL, KW_STRUCT, KW_TAG,
    KW_TEST, KW_TODO, KW_TRAIT, KW_TRANSACT, KW_TRANSITION, KW_UNSAFE, KW_USE, KW_WRAP, LIT_FALSE,
    LIT_NULL, LIT_TRUE, PROTO_CLIENT, PROTO_SERVER, TYPE_BITS, TYPE_BOOL, TYPE_BTREE_MAP,
