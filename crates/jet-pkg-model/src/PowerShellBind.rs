...
static const char pwsh_path[]="{}";static const char worker_path[]="{}";static const char script_path[]="{}";
...
{wrappers}"#,c_escape(&pwsh.to_string_lossy()),c_escape(&worker.to_string_lossy()),c_escape(&script.to_string_lossy()))}
