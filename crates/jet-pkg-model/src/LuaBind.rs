...
fn reserved(v:&str)->bool{matches!(v,"open"|"cancel"|"close"|"Session"|"TableView"|"LuaError"|"view_get_int"|"view_set_int")||crate::Syntax::JET_KEYWORD_LIST.contains(&v)||crate::Syntax::JET_TYPE_LIST.contains(&v)}
