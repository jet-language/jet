;; Nondeterministic guest (D-DX5-HOOK1 deterministic sandbox law):
;; imports WASI random — denied by the empty linker; must fail closed at load.
(component
  ...
  (core module $m
    ...
    (func $analyze (export "analyze") (param i32 i32) (result i32) (i32.const 0))
  )
