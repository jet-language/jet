...
pub(crate) fn handle_method_op(handle: &str, method: &str, nargs: usize) -> Option<THandleOp> {
    let op = match (handle, method, nargs) {
        ...
        ("TcpListener", "accept", 1) => THandleOp::TcpListenerAcceptDeadline,
        ("TcpListener", "local_addr", 0) => THandleOp::TcpListenerLocalAddr,
        ("TcpStream", "read", 0) => THandleOp::TcpStreamRead,
        ("TcpStream", "read", 1) => THandleOp::TcpStreamReadBytes,
        ("TcpStream", "read", 2) => THandleOp::TcpStreamReadBytesDeadline,
        ("TcpStream", "read_text", 1) => THandleOp::TcpStreamReadText,
        ("TcpStream", "read_text", 2) => THandleOp::TcpStreamReadTextDeadline,
        ("TcpStream", "write", 1) => THandleOp::TcpStreamWriteBytes,
        ("TcpStream", "write", 2) => THandleOp::TcpStreamWriteBytesDeadline,
        ("TcpStream", "write_all", 1) => THandleOp::TcpStreamWriteAllBytes,
        ("TcpStream", "write_all", 2) => THandleOp::TcpStreamWriteAllBytesDeadline,
        ("TcpStream", "write_text", 1) => THandleOp::TcpStreamWriteText,
        ("TcpStream", "write_text", 2) => THandleOp::TcpStreamWriteTextDeadline,
