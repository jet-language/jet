...
mod tests {
    ...
    fn blake2b_exact_block_matches_standard_kat() {
        ...
        let expected = [
            0x86, 0x59, 0x39, 0xe1, 0x20, 0xe6, 0x80, 0x54, 0x38, 0x47, 0x88, 0x4a, 0xfb, 0x73,
            0x9a, 0xe4, 0x25, 0x0c, 0xf3, 0x72, 0x65, 0x30, 0x78, 0xa0, 0x65, 0xcd, 0xcf, 0xfa,
            0x4c, 0xaf, 0x79, 0x8e, 0x6d, 0x46, 0x2b, 0x65, 0xd6, 0x58, 0xfc, 0x16, 0x57, 0x82,
            0x64, 0x0e, 0xde, 0xd7, 0x09, 0x63, 0x44, 0x9a, 0xe1, 0x50, 0x0f, 0xb0, 0x0f, 0x24,
            0x98, 0x1d, 0x77, 0x27, 0xe2, 0x2c, 0x41,
        ];
        assert_eq!(actual, expected);
    }
