//! Jet Zed extension — launches `jet self lsp`.
//!
//! Zed 0.7.0 does not expose the trust and authorization hooks required for
//! safe native debugging. The extension therefore intentionally exposes no
//! debugger adapter until that API is available.
