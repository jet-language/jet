...
const JET_HIGHLIGHT_MARKER_DIRECTIVE = ["Abi", "Bench", "Bindgen", "Caller", "Caps", "DebugOnly", "Default", "DenyUnknownFields", "Extern", "Flatten", "Grant", "Html", "Impure", "Invariant", "Js", "Layout", "Meta", "Off", "Reactive", "Rename", "RenameAll", "Replayable", "Sanitizer", "SingleUse", "Skip", "Sql", "State", "Suppress", "Tag", "Tainted", "Target", "Test", "Todo", "Track", "Transact", "Transition", "UnitFamily", "Unsafe", "Untagged", "Wasm", "WasmExport"];
const JET_HIGHLIGHT_MARKER_CONTRACT = ["Cli", "Codable", "CodableAsBase", "Comparable", "Debug", "Decode", "Doc", "Encode", "Inline", "InlineAlways", "MustUse", "Numeric", "Patchable", "Persist", "Post", "Pre", "Printable", "PublishedSchema", "Pure", "Redact", "Summarize"];
