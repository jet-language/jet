...
const JET_HIGHLIGHT_TYPE_BUILTIN = ["BTreeMap", "BigInt", "Bool", "Char", "Computed", "Csv", "Data", "DbValue", "Decimal", "Deque", "Derived", "Effect", "Error", "Event", "EventPolicy", "EventScope", "EventTrace", "F32", "F64", "Float", "HashMap", "Hook", "I16", "I32", "I64", "I8", "IOError", "Int", "JSON", "JSONError", "Json", "Key", "Measurement", "Ptr", "SelectBuilder", "Set", "Shared", "Signal", "Stream", "String", "Subscription", "TaskGroup", "Toml", "U16", "U32", "U64", "U8", "UTF8Error", "Void", "Yaml"];
const JET_HIGHLIGHT_BUILTIN = ["input", "print"];
const JET_HIGHLIGHT_MARKER_DIRECTIVE = ["Bench", "Bindgen", "Caller", "Caps", "Default", "DenyUnknownFields", "Extern", "Flatten", "Grant", "Html", "Impure", "Js", "Layout", "Reactive", "Rename", "RenameAll", "Sanitizer", "SingleUse", "Skip", "Sql", "State", "Suppress", "Tag", "Tainted", "Target", "Test", "Todo", "Track", "Transact", "Transition", "UnitFamily", "Unsafe", "Untagged", "Wasm", "WasmExport"];
