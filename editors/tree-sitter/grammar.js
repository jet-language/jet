...
const JET_HIGHLIGHT_MARKER_DIRECTIVE = ["Bench", "Bindgen", "Caller", "Caps", "Default", "DenyUnknownFields", "Extern", "Flatten", "Grant", "Html", "Impure", "Invariant", "Js", "Layout", "Reactive", "Rename", "RenameAll", "Replayable", "Sanitizer", "SingleUse", "Skip", "Sql", "State", "Suppress", "Tag", "Tainted", "Target", "Test", "Todo", "Track", "Transact", "Transition", "UnitFamily", "Unsafe", "Untagged", "Wasm", "WasmExport"];
