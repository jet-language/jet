...
| Bounded streaming bodies | Partial: HTTP/2 request/response bodies stream with flow-control backpressure and cancellation; the HTTP/1 compatibility path still buffers decoded request text up to the 1 MiB body cap |
