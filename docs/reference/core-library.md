...
| Pooling and HTTP/2 | Partial: native HTTP/2 server serving is shipped over cleartext preface and rustls ALPN; client pooling/HTTP/2 transport is tracked under D-HTTP-CLIENT2 |
