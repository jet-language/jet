...
| Build, test, debug, and Git | `git-diff-review` | Linux Git diff inspection proved; build, test, and debug not run; macOS declared native but not run; Windows cannot count Bash as native | #769 |
