...
- **Surface census**: 63 markers (24 `@`, 39 `#` — 3 of the `#` set
  just ratified away), 111 KW_ entries, ~70 core modules, 587
  diagnostic codes.
- **Census/law drift in Syntax.rs**: `view` listed as a keyword
  ...
  trio listed in `#`-plane arrays while law says `@` (D-MATURITY1).
