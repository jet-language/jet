...
| E1294 | jetpack | `jetpack tool install` bin name collides with a project `#Task fn` (JPK-TOOL-COLLIDE, D-JPK-TOOLRUN1) |
| E1295 | jetpack | `jetpack tool` ref names an external provider with no hangar realization path yet (JPK-TOOL-PROVIDER, D-JPK-TOOLRUN1) |
