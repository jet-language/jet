...
in tools/Tower/docs/plans/jetpack-jetos/unified-ecosystem.md (§10: D-PM1…8). Public binary/dev-shell package
management is the owner-gated `jetpack` track in
tools/Tower/docs/plans/jetpack-jetos/README.md; jetos is Phase 2 on top of jetpack.
