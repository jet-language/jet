...
| --- | --- | ---: | --- |
| docs | docs/reference/syntax-surface.jet | 503:1 | "reads through a raw pointer; addr must be live and valid" |
| docs | docs/reference/syntax-surface.jet | 506:5 | "addr is the address of a live Int on this frame" |
