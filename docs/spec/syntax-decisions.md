...
| 2026-06-27 | D-WEBBACKEND1 | **web backend is JS DOM + WASM logic hybrid** (A): view/DOM work emits JS; compute/pure logic can compile to WASM. **Ratified — blocked on D-WASM1 and related web partition details.** c123 | owner |
