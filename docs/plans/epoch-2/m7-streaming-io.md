...
| D-IO2 | Cleanup surface | **A** — RAII handle types (S63), drop on scope exit | A | ✅ ratified 2026-06-17 — A: RAII handles; close on every exit path including `?`; no keyword to forget |
