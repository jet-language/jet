...
| Workbench | Cut/copy/paste/duplicate | Source transactions duplicate or move source-backed selections; staged fallback remains local until connected. | shipped | interaction:tests/canvas_scenarios.rs::selection_marquee_modifiers_local_move; unit:tests/canvas.rs::canvas_source_paste_is_renamed_checked_and_stale_atomic |
