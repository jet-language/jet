...
| Node model | Large graph virtualization and LOD | Canvas renders visible graph regions and low-zoom title-bar nodes for large projections. | shipped | interaction:tests/canvas_scenarios.rs::big_project_perf_budget — generated 300-function project, measured Chromium pan/zoom/selection/palette/file-switch frames, and culling hit/focus/minimap/source checks on two clean runs |
