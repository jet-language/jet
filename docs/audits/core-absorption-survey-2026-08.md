...
Evidence base: [Core library reference](../spec/reference/core-library.md),
[Core surface ledger](../spec/reference/core-surface-ledger.json), and the prior
...
[`docs/reference/framework-transplant-closeout.md`](framework-transplant-closeout.md)
