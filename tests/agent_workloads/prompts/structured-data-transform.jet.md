# Task: structured-data-transform
...
The input directory contains exactly this, with small files shown inline:
    ...
    records.json  (116 bytes)
      | {"events":[{"service":"web","duration_ms":9},{"service":"api","duration_ms":12},{"service":"api","duration_ms":5}]}
      | 
...
{"total_events":3,"summaries":[{"service":"api","count":2,"total_ms":17},{"service":"web","count":1,"total_ms":9}]}
----- END EXPECTED STDOUT -----
