...
The input directory contains exactly this, with small files shown inline:
    ...
    after/
    after/docs/
    after/docs/release notes.md  (31 bytes)
      | # Release notes
      | 
      | Status: ready
      | 
    after/src/
    after/src/new-name.txt  (13 bytes)
      | same content
      | 
    after/src/unchanged.txt  (10 bytes)
      | unchanged
      | 
    before/
    before/docs/
    before/docs/release notes.md  (31 bytes)
      | # Release notes
      | 
      | Status: draft
      | 
    before/src/
    before/src/old-name.txt  (13 bytes)
      | same content
      | 
    before/src/unchanged.txt  (10 bytes)
      | unchanged
      | 
...
docs/release notes.md|modified
src/new-name.txt|added
src/old-name.txt|deleted
