# Task: browser-automation-preflight

Domain: browser-and-desktop-work
Case: profile-timeout-hostile
...
profile|bidi-2025.5|accepted
profile|rolling|rejected
timeout|500|accepted
timeout|0|rejected
connect|ws://127.0.0.1:1|rejected
----- END EXPECTED STDOUT -----
