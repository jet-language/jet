# Task: media-asset-inventory

Domain: document-and-media-work
Case: unsupported-media-hostile
...
asset|poster.svg|image/svg+xml|63
asset|sample.mp3|audio/mpeg|9
reject|unknown.zzz|extension
----- END EXPECTED STDOUT -----
