...
const UI_PARSE_INVALID: &[&str] = &[
    ...
    "tests/ui/E0927_unknown_marker_block.jet",
    "tests/ui/E0927_unknown_marker_constant.jet",
    "tests/ui/E0927_unknown_marker_distinct.jet",
    "tests/ui/E0927_unknown_marker_expression.jet",
    "tests/ui/E0927_unknown_marker_parameter.jet",
    "tests/ui/E0927_unknown_marker_statement.jet",
    ...
    "tests/ui/comptime_prefix_dollar_retired.jet",
    "tests/ui/computed_fixed_list_noninteger.jet",
    "tests/ui/computed_fixed_list_range.jet",
    ...
    "tests/ui/declared_text_block_undeclared.jet",
    ...
    "tests/ui/fact_plane_type_position.jet",
    "tests/ui/fact_read_type_position.jet",
    "tests/ui/fallible_unit_return_retired.jet",
    ...
    "tests/ui/foreign_declaration_binding.jet",
    ...
    "tests/ui/marker_retired_html_name.jet",
    "tests/ui/marker_retired_known.jet",
    "tests/ui/marker_retired_sql_angle.jet",
    ...
    "tests/ui/module_brace_group.jet",
    ...
    "tests/ui/task_group_parameter_label.jet",
    "tests/ui/task_group_value.jet",
    "tests/ui/task_unknown_selector.jet",
