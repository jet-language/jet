...
use cmd_compile::{run_compile_cmd, run_fix, run_fmt, run_new, run_test};
use cmd_dev_tools::{
...
use cmd_supply::{run_audit, run_publish, run_sbom, run_vendor};
...
pub(crate) fn report_problems(mode: OutputMode, file: &str, src: &str, diags: &[jet::diag::Diagnostic]) {
    if mode.json {
